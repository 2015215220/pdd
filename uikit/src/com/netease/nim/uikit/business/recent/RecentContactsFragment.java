...
//    public void setListener(onRecentClickedListener listener) {
//        Listener = listener;
//    }
//
//    private   onRecentClickedListener Listener;
...
//                    if(Listener!=null){
//                        Listener.onRecentClicked(recent);/////////聊天界面
//                    }else{
//                        ToastHelper.showToast(getActivity(),"没有界面");
//                    }
                }
            }
...
//    public interface onRecentClickedListener {  //监听事件
//        void onRecentClicked(RecentContact recentContact);//传值
//    }
}
